...
//         Text(ciaoooo); let s = 'The quick brown fox jumped over the lazy dog.';
//         fill(50);
//         text(s, 10, 10, 70, 80 )
//     }
// }
...
const displayTextOnStop = () => {
    ...
    // go through the 'stop time' array and find the matched element
    // if we find matched element then display the text
